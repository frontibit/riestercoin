...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Riestercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed.fh-biergarten.de"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet-seed.fh-biergarten.de"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Riestercoin is probably already running."), addrBind.ToString().c_str());
        else
